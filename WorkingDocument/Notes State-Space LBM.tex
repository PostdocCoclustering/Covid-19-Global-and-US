...
\begin{equation}\label{SIR}
	\frac{d\theta_t^S}{dt} = -\rho\theta_t^S\theta_t^I, \quad \frac{d\theta_t^I}{dt} = \rho\theta_t^S\theta_t^I - \pi \theta_t^I, \quad \frac{d\theta_t^R}{dt} = \pi \theta_t^I,
\end{equation}
%
...
\begin{aligned}
	y_{ij}^I | \boldsymbol{\theta}, \boldsymbol{\Omega}_1 \sim \text{Beta}(\lambda^I \theta_t^I, \lambda^I(1 - \theta_t^I)) \\
	%
	y_{ij}^R | \boldsymbol{\theta}, \boldsymbol{\Omega}_1 \sim \text{Beta}(\lambda^R \theta_t^R, \lambda^R(1 - \theta_t^R)
\end{aligned}
\end{equation}
%
where 
%
$
\boldsymbol{\Omega}_1 = (\rho, \pi, \mathbf{\theta}, \lambda, \kappa)^\top.
$
%
...
%
$ 
\boldsymbol{\Omega}_1 = (\rho, \pi, \boldsymbol{\theta}, \lambda, \kappa)
$ 
%
...
%
$
\boldsymbol{\Omega} = \boldsymbol{\Omega}_1 + \boldsymbol{\Omega}_2 = (\rho, \pi, \boldsymbol{\theta}, \lambda, \kappa, \alpha, \beta, \omega).
$
%
