...
\begin{figure}[H]\label{HMMM}
	...
	\begin{tikzpicture}
		...
		\node[main] (theta0) [right=of T] {$\boldsymbol{\theta}_0$};
		\node[main] (theta1) [right=of theta0] {$\boldsymbol{\theta}_{k1}$};
		\node[main] (theta2) [right=of theta1] {$\boldsymbol{\theta}_{k2}$};
		\node[main] (theta11) [right=of theta2] {$\boldsymbol{\theta}_{k1}$};
		\node[main] (theta3) [right=of theta11] {$\boldsymbol{\theta}_{k3}$};		
		\node[main, fill = gray!25] (y1) [below=of theta1] {$\mathbf{y}_{k1}$};
		\node[main, fill = gray!25] (y2) [right=of y1] {$\mathbf{y}_{k2}$};
		\node[main, fill = gray!25] (y11) [right=of y2] {$\mathbf{y}_{k3}$};
		\node[main, fill = gray!25] (y3) [right=of y11] {$\mathbf{y}_{k4}$};		
